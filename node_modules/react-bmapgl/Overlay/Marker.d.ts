...
declare type IconString = 'simple_red' | 'simple_blue' | 'loc_red' | 'loc_blue' | 'start' | 'end' | 'location' | 'red1' | 'red2' | 'red3' | 'red4' | 'red5' | 'red6' | 'red7' | 'red8' | 'red9' | 'red10' | 'blue1' | 'blue2' | 'blue3' | 'blue4' | 'blue5' | 'blue6' | 'blue7' | 'blue8' | 'blue9' | 'blue10';
...
declare class Marker extends Component<MarkerProps> {
    static contextType: import("react").Context<import("../Map").MapContextProps>;
...
declare const _default: typeof Marker;
/**
 * 在地图上绘制简单的标注点
